"""Semantic search over indexed Tandoor recipes.

Usage (needs the shared Qdrant secret, not the Tandoor one — search
doesn't call the Tandoor API):
    sops exec-env ../../secrets.enc.env 'uv run search.py "вафлі"'
"""
